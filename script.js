...
const likesUser = document.querySelector('.like_user');
let btnUserLike = document.querySelectorAll('#listLike')
const btnClearLike= document.getElementById('clearBox__likes');
const overBg =document.querySelector('#overBg')
likesUser.style.display = 'none';
btnUserLike.forEach(btn => {
  ...
  btnClearLike.addEventListener('click',(e)=>{
    e.preventDefault();
